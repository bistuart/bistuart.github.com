...
Class User_PayOnline
	   ...
	   Sub PayStep3()
		...
		Dim ReturnUrl:ReturnUrl=KS.GetDomain & "user/User_PayReceive.asp?PaymentPlat=" & PaymentPlat &"&username=" & KSUser.userName & "&action=" &KS.S("PayFrom")&"&usercardid=" & UserCardID   ' 商户自定义返回接收支付结果的页面 Receive.asp 为接收页面
		...
		Case 6   '云网支付
		 ...
		 Case 8  '快钱支付
			...
			key = MD5Key '网关密钥
			inputCharset = "1" '1代表UTF-8; 2代表GBK; 3代表gb2312
			pageUrl = "" '接受支付结果的页面地址

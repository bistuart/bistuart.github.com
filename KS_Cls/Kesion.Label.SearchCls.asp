...
Class RefreshSearchCls
		...
		Function GetSearch()
			   ...
			   GetSearch = GetSearch & "搜索： <input name=""key"" type=""text"" class=""textbox"" value=""请输入关键字"" onfocus=""this.select();""/><span>" & vbCrLf
			   ...
			   GetSearch = GetSearch & "<input type=""submit"" class=""inputButton"" name=""Submit1"" value=""站内搜索"" />" & vbCrLf

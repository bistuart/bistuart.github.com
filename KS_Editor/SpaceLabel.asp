...
<table align="center" width="95%" border="0" cellspacing="0" cellpadding="0">
		 ...
		 <tr>
		  <td width="150"><li><a href='#' onClick="parent.InsertLabel('TemplateSub0','{$ShowNewLog}');">{$ShowNewLog}</a></td><td>---最新1篇日志</td>
	       <td><li><a href='#' onClick="parent.InsertLabel('TemplateSub0','{$ShowNewAlbum}');">{$ShowNewAlbum}</a></td><td>---最新3本相册</td>
		 </tr>
		 <tr>

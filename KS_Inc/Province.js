...
cityareacode[1]=new Array('罗湖区','福田区','南山区','盐田区','宝安区','龙岗区');
cityareaname[1]=new Array('罗湖区','福田区','南山区','盐田区','宝安区','龙岗区');
if (prov=='03')
...
cityareacode[5]=new Array('广州','珠海','中山','佛山','东莞','清远','肇庆','阳江','湛江','茂名','韶关','惠州','河源','汕尾','汕头','梅州');
cityareaname[5]=new Array('广州','珠海','中山','佛山','东莞','清远','肇庆','阳江','湛江','茂名','韶关','惠州','河源','汕尾','汕头','梅州');
if (prov=='07')

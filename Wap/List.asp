			...
			If Ubound(PageParamArr)>0  Then
			   If PageParamArr(0)="GetShowClassCent" Then
				  ...
				  If Cbool(PageParamArr(1))=True Then
					 ...
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sType=1&amp;" & KS.WapValue & """>文字简版</a> "
					 End If
					 If sType=2 Then
					    TempStr = TempStr & "豪华详版<br/>"
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sTypeNum=4&amp;sType=2&amp;" & KS.WapValue & """>豪华详版</a><br/>"
					 End If
				  End If
				  ...
				  If Cbool(PageParamArr(2))=True Then
				     If sPai=1 Then
					    TempStr = TempStr & "最早 "
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=1&amp;sTypeNum=" & sTypeNum & "&amp;sType=" & sType & "&amp;" & KS.WapValue & """>最早</a> "
					 End If
					 If sPai=2 Then
					    TempStr = TempStr & "最新 "
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=2&amp;sTypeNum=" & sTypeNum & "&amp;sType=" & sType & "&amp;" & KS.WapValue & """>最新</a> "
					 End If
					 If sPai=3 Then
					    TempStr = TempStr & "热门 "
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=3&amp;sTypeNum=" & sTypeNum & "&amp;sType=" & sType & "&amp;" & KS.WapValue & """>热门</a> "
					 End If
					 If sPai=4 Then
					    TempStr = TempStr & "随机<br/>"
					 Else
					    TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=4&amp;sTypeNum=" & sTypeNum & "&amp;sType=" & sType & "&amp;" & KS.WapValue & """>随机</a><br/>"
					 End If
				  End If
				  ...
				  If sType=2 Then
				     If CurrPage=1 Then
						...
						If sTypeNum=2 Then
						   TempStr = TempStr & "2 "
						Else
						   TempStr = TempStr & "<a href=""?ID=" & ID &"&amp;sPai=" & sPai & "&amp;sTypeNum=2&amp;sType=" & sType & "&amp;" & KS.WapValue & """>2</a> "
						End If
						If sTypeNum=4 Then
						   TempStr = TempStr & "4 "
						Else
						   TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai="&sPai&"&amp;sTypeNum=4&amp;sType=" & sType & "&amp;" & KS.WapValue & """>4</a> "
						End If
						If sTypeNum=6 Then
						   TempStr = TempStr & "6 "
						Else
						   TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=" & sPai & "&amp;sTypeNum=6&amp;sType=" & sType & "&amp;" & KS.WapValue & """>6</a> "
						End If
						If sTypeNum=8 Then
						   TempStr = TempStr & "8 "
						Else
						   TempStr = TempStr & "<a href=""?ID=" & ID & "&amp;sPai=" & sPai & "&amp;sTypeNum=8&amp;sType=" & sType & "&amp;" & KS.WapValue & """>8</a> "
						End If
				  ...
				  Else
					 ...
					 TempStr = TempStr & KS.GetPageList("?" & KS.QueryParam("page") &"&amp;",PageStyle,CurrPage,PageNum, True)
				  End If

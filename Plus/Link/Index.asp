...
Class Link
		...
		Public Sub Kesion()
		 ...
		 Set KSR = New Refresh
			If KS.Setting(113)="" Then Response.Write "请先到""基本信息设置->模板绑定""进行模板绑定操作!":response.end
		...
		Function GetDetailListStr(ObjRS, totalPut, MaxPerPage, CurrentPage, RClassID)
			  Dim AddDate, I, RecommendStr,LinkID
				  Do While Not ObjRS.EOF
					 ...
					 Loop
					 GetDetailListStr = GetDetailListStr & "<table width=""100%"" aling=""center""><tr><td align=right>" & KS.ShowPagePara(totalPut, MaxPerPage, "Index.asp", True, "个站点", CurrentPage, "ClassID=" & RClassID & "&LinkType=" & KS.S("LinkType") & "&ViewKind=" & KS.S("ViewKind")) & "</td></tr></table>"
		End Function
		'结合上面ReplaceListContent函数使用

...
Class Group
		...
		showtopic=showtopic &"<script type=""text/javascript"">function checkform(){if (FCKeditorAPI.GetInstance('Content').GetXHTML(true)==''){alert('请输入回复内容!');FCKeditorAPI.GetInstance('Content').Focus();return false;}return true;}</script>"
		...
		showtopic=showtopic &"	  <td colspan=""2"" bgcolor=""#EDF5F9""><strong>回复话题</strong></td>"
		showtopic=showtopic &"	</tr>"
		...
		showtopic=showtopic &"	</tr>"
		showtopic=showtopic &"	<tr>"
		showtopic=showtopic &"		<td width=""100"" align=""center"" bgcolor=""#FFFFFF"">内容:</td>"
		...
		showtopic=showtopic &"		<input type=""submit"" value=""提交回复"">"
        showtopic=showtopic &"        </td>"
		showtopic=showtopic &"	</tr>"
			end if
		...
		showpost=showpost & "</ul>"
		showpost=showpost & "<ul><input type='submit' value='OK,发表 '></ul>"

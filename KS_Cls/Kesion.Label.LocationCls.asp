...
Class RefreshLocationCls
		   ...
		   Select Case UCase(FCls.RefreshType)
			 ...
			 case "GUESTINDEX" 
			  ...
			  If Request("pid")<>"" Then
			   ...
			   Str=Str & Navistr & Node.SelectSingleNode("@boardname").text & Navistr & "版面列表"
			   End If
			  ElseIf Request("boardid")<>"" Then
			   ...
			   Str=Str & Navistr & Node.SelectSingleNode("@boardname").text & Navistr & KS.Setting(62) & "列表"
			   End If
			  End If
			 case "GUESTWRITE" 
			  str="<a href='index.asp'>" & KS.Setting(61) & "</a>"
			 ...
			 case "RESUMESEARCH" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "查找人才" 
			 case "SEARCHZW" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "查找职位" 
			 case "RESUMESC" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "简历收藏夹" 
			 case "COMPANYSHOW" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "查看公司详情" 
			 case "JOBREAD" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "查看职位详情" 
			 case "JOBAPPLY" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "申请职位" 
			 case "LETTER" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "求职信" 
			 case "ZHAOPIN" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "企业招聘" 
			 case "QIUZHI" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "个人求职" 
			 case "JOBLTINDEX" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "猎头服务首页" 
			 case "JOBLTINTRO" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "猎头介绍" 
			 case "JOBLTNEWS" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "最新猎头职位"
			 case "JOBJZJOB" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "最新兼职职位"
			 case "JOBJZRESUME" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "最新兼职人才"
			 case "JOBJZINDEX" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "兼职天地首页" 
			 case "RESUMESEARCH" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "简历搜索列表" 
			 case "JOBSEARCH" str= "<a " & TitleCss & " href=""index.asp""" & KS.G_O_T_S(OpenType) & ">求职招聘</a>" & NaviStr & "职位搜索列表" 
		...
		Function GetFolderLocation(StartTag, NaviStr, OpenType, TitleCss, RefreshFolderIDValue)
			...
			Else
				If FCls.RefreshChannelHomeFlag = True Then
				  GetFolderLocation = StartTag & "<a " & TitleCss & " href=""" & DomainStr & """" & KS.G_O_T_S(OpenType) & ">" & WebNameStr & "</a>" & FolderNaviStr & NaviStr & "首页"
				Else
		...
		Function GetMusicIndexLocation(StartTag, NaviStr, OpenType, TitleCss)
			  GetMusicIndexLocation = StartTag & "<a " & TitleCss & " href=""" & DomainStr & """" & KS.G_O_T_S(OpenType) & ">" & WebNameStr & "</a>" & NaviStr & "<a " & TitleCss & " href=""" & DomainStr & "Music/" & KS.G_O_T_S(OpenType) & """>音乐频道</a>" & NaviStr & "首页"
		End Function

		'取得音乐歌手列表页导航位置的函数
		Function GetMusicSingerLocation(StartTag, NaviStr, OpenType, TitleCss)
			  GetMusicSingerLocation = StartTag & "<a " & TitleCss & " href=""" & DomainStr & """" & KS.G_O_T_S(OpenType) & ">" & WebNameStr & "</a>" & NaviStr & "<a " & TitleCss & " href=""" & DomainStr & "Music/" & KS.G_O_T_S(OpenType) & """>音乐频道</a>" & NaviStr & Application(KS.SiteSN & "RefreshMusicTempStr")  &NaviStr & "歌手导航列表"
		End Function
		
		'取得音乐歌手专辑列表页导航位置的函数
		Function GetMusicSingerSpecialLocation(StartTag, NaviStr, OpenType, TitleCss)
			  GetMusicSingerSpecialLocation = StartTag & "<a " & TitleCss & " href=""" & DomainStr & """" & KS.G_O_T_S(OpenType) & ">" & WebNameStr & "</a>" & NaviStr & "<a " & TitleCss & " href=""" & DomainStr & "Music/" & KS.G_O_T_S(OpenType) & """>音乐频道</a>" & NaviStr & KS.C("RefreshMusicClass") &NaviStr & Application(KS.SiteSN & "RefreshMusicSingerTempStr") & NaviStr & "所有专辑"
		End Function
		'取得音乐最终专辑歌曲列表页导航位置的函数
		Function GetMusicSpecialLocation(StartTag, NaviStr, OpenType, TitleCss)
			  GetMusicSpecialLocation = StartTag & "<a " & TitleCss & " href=""" & DomainStr & """" & KS.G_O_T_S(OpenType) & ">" & WebNameStr & "</a>" & NaviStr & "<a " & TitleCss & " href=""" & DomainStr & "Music/" & KS.G_O_T_S(OpenType) & """>音乐频道</a>" & NaviStr & Application(KS.SiteSN & "RefreshMusicTempStr")  &NaviStr & Application(KS.SiteSN & "RefreshMusicSingerTempStr") & NaviStr & Application(Cstr(KS.SiteSN & "RefreshMusicSpecialNameTempStr")) & "专辑歌曲列表"
		End Function
        '购物流程

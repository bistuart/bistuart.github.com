...
Sub ShowRSS()
	 Dim FileContent
	 Dim RssTemplatePath:RssTemplatePath=KS.Setting(3) & KS.Setting(90) & "rss.html"  '模板地址
...
Sub RssList()
				...
				If IsOBject(ClassXml) Then
				  For Each Node In ClassXML.DocumentElement.SelectNodes("row")
					  ...
					  If tJ=1 Then
				        TreeStr = TreeStr  & "<div class=""rss""><li>" & KS.GetClassNP(Node.SelectSingleNode("@id").text)& "</li><span class=""r""><a href=""rss.asp?classid=" & Node.SelectSingleNode("@id").text & "&channelid=" & Node.SelectSingleNode("@channelid").text & """ target=""_blank""><img src=""images/rss_xml.gif"" border=""0""></a></span></div>"
					  Else
						SpaceStr=""
						For k = 1 To TJ - 1
						  SpaceStr = SpaceStr & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
						Next
	                    TreeStr = TreeStr & "<div class=""rss"">" & SpaceStr & KS.GetClassNP(Node.SelectSingleNode("@id").text) & "<span class=""r""><a href=""rss.asp?classid=" & Node.SelectSingleNode("@id").text & "&channelid=" & Node.SelectSingleNode("@channelid").text & """ target=""_blank""><img src=""images/rss_xml.gif"" border=""0""></a></span></div>" & vbcrlf
					  End If
				  Next
				End If
...
Function GetShowRssBody(RssTemplateTF)
	...
	GetShowRssBody	=GetShowRssBody & "<generator>Rss Generator By Kesion.Com</generator>"&vbcrlf
	GetShowRssBody	=GetShowRssBody & "<language>zh-cn</language>"&vbcrlf
	GetShowRssBody	=GetShowRssBody & "<copyright>Copyright 2006-2010 KeSion.Com .All Rights Reserved</copyright>"&vbcrlf

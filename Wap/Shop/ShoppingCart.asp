...
Class ShoppingCart
		...
		Public Sub Kesion()
			...
			If Cbool(KSUser.UserLoginChecked)=False Then
			   Response.Write "温馨提示：您还没有注册或登录。享受更多会员优惠，请先<a href=""User/Login/?../ShoppingCart.asp?ID="&KS.S("ID")&""">登录</a>或<a href=""User/Reg/?../ShoppingCart.asp?ID="&KS.S("ID")&""">注册</a>成为商城会员！<br/>" &vbcrlf
			Else

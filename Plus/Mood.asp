...
Function GetVoteStr()
	...
	RST.Open "Select * From KS_MoodList Where ChannelID=" & ChannelID & " And InfoID=" & InfoID & " And MoodID=" & MoodID,conn,1,1
	If Not RST.Eof Then
	 For I=0 To 14
	...
	VoteStr=VoteStr & "<table border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0""><tr><td class=""mood_top"" colspan=""15"">您看到此" & KS.C_S(ChannelID,4) & KS.C_S(ChannelID,3) & "时的感受：</td></tr><tr>"
	For I=0 To Ubound(VoteArr)
	 If trim(VoteArr(I))<>"" Then
	   ...
	   If Ubound(VoteItemArr)>=1 And VoteItemArr(0)<>"" And VoteItemArr(1)<>"" Then
		 ...
		 VoteStr=VoteStr & "<td valign=""bottom""  style=""text-align:center"">" & ItemVoteNum(I) & "<br><img alt=""" & Percentage & "%"" src=""" & KS.Setting(2) & "/images/default/post.gif"" height=""" & PerVote*50 & """ width=""20""><br><img alt=""" & VoteItemArr(0) & """ src=""" & ImgSrc & """ border=""0""><br>" & VoteItemArr(0) & "<br><input type=""radio"" onclick=""MoodPosition(" & I &");"" name=""votebutton""></td>"
	   End If
	 End If
	Next
	VoteStr=VoteStr & "</tr>"

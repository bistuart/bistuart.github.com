...
Function GetRssBody()
		  sTitle = sTitle & "-最新日志"
		 Dim SqlStr,SQL,Rs,i
		   SqlStr="Select Top " &RssChannelNum & " ID,Title,Content,AddDate From KS_BlogInfo Where UserName='" & UserName & "'  and status=0 Order By ID Desc"
		...
		Else
			Do While Not RS.Eof 
				...
				GetRssBody = GetRssBody & "<link><![CDATA[" & KSBCls.GetCurrLogUrl(RS(0),UserName) & "]]></link>"&vbcrlf

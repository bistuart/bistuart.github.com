...
Class SiteIndex
		...
		Sub getadslist()
		 ...
		 If DataBaseType=0 then
		  Param=Param & " and datediff('d',BeginDate," &SqlNowString & ")<datatimed"
		 else
		  Param=Param & " and datediff(day,BeginDate," &SqlNowString & ")<datatimed"
		 end if
		 rs.cursorlocation = 3
		...
		Sub GetClassList()
		 ...
		 if Pid<>0 then
			 ...
			 for i=1 to 5
			   ...
			   str=str & "<div style=""height:20px;""><img src=""../images/arrow_r.gif""> <a href=""list.asp?id=" & rs(0) & """>" & rs(1) &"</a>(" & conn.execute("select count(id) from ks_enterprise where status=1 and smallclassid=" & rs(0))(0) &") </div>" & vbcrlf
		...
		Sub GetCompanyList()
		 ...
		 Dim SqlStr:SqlStr="select b.logo,[Domain],a.username,a.companyname,a.province,a.city,a.recommend,a.intro,a.RegisteredCapital,a.address,a.telphone,a.viptf,a.placevalue from ks_enterprise a inner join ks_blog b on a.username=b.username" & Param & SortStr
		...
		Sub ShowContent(RS)
		 ...
		 Dim I,logo,n,url,msgUrl
 		 c_str="<img src='../images/order_arrow.gif' align='absmiddle'><a href='?pid=" & Pid & "&id="&ks.g("id") & "'>默认排序</a> <img src='../images/order_arrow.gif' align='absmiddle'><a href='?recommend=1&pid=" & Pid & "&id="&ks.g("id") & "'>推荐企业</a> <img src='../images/order_arrow.gif' align='absmiddle'><a href='?t=1&pid=" & Pid & "&id="&ks.g("id") & "'>加盟时间</a>"
        ...
        c_str=c_str & "<td width=""85"" align=""center"">积分排名</td>"
         ...
         c_str=c_str & "<td width=""150"" height=""80"" align=""center""><div style=""border:1px solid #666666;padding:3px""><a href='" & url & "' target='_blank'><img src=""" & logo & """ width=136 height=56 border='0'></a></div></td>"
         ...
         c_str=c_str & "<td width=""100"" align=""center"">" & RS("Province") & RS("City") & "</div></td>"
        ' c_str=c_str & "<td width=""85"" align=""center""><a href='../space/space.asp?username=" & RS(2) & "' target='_blank'>" & RS("placevalue") & "</a></td>"
         c_str=c_str & "<td width=""90"" align=""center"">" & RS("RegisteredCapital") & "</td>"
         c_str=c_str & "<td width=""70"" align=""center"">" 
		' if rs("viptf")<>"0" then
		  'c_str=c_str &"<img src='/images/trust.gif' alt='诚信企业'/><br/><span style='color:#999999'>诚信会员</span>"
		' else
		 ' c_str=c_str & "---"
		' end if
		 ' select case groupid
		   'case 8 c_str=c_str & "<a href='../wt/index.asp?username=" & rs("username") & "' target='_blank'>装修招标</a>"
		   'case 9 c_str=c_str & "<a href='../Pro_ZB/index.asp?username=" & rs("username") & "' target='_blank'>产品招标</a>"
		   'case 7 c_str=c_str & "<a href='../space/message.asp?username=" & rs("username") & "' target='_blank'>发送留言</a>"
		  ' case else c_str=c_str & "---"
		...
		Sub getarealist()
		  ...
		  If IsArray(SQL) Then
			  ...
			  For i=0 To Ubound(SQL,2)
				...
				astr=astr & "<td><img src='../images/arrow_r.gif'> <a href=""list.asp?province=" & province & "&provinceid=" & ks.s("provinceid") & "&city=" & sql(0,n) & """>" & sql(0,n) & "</a></td>"
				 Else

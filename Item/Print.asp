	   ...
	   Sub PayConfirm()
	     If UserLoginTF=false Then Call GetNoLoginInfo():Exit Sub
			 If Cint(KSUser.Point)<ReadPoint Then
					 ArticleContent="<div align=center>对不起，你的可用" & KS.Setting(45) & "不足!阅读本文需要 <font color=red>" & ReadPoint & "</font> " & KS.Setting(46) & KS.Setting(45) &",你还有 <font color=green>" & KSUser.Point & "</font> " & KS.Setting(46) & KS.Setting(45) & "</div>,请及时与我们联系！" 
			 Else
					If PayTF="yes" Then
